...
namespace TaxiFarePredictionML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Training\ML Repository\TaxiFarePrediction\TaxiFarePrediction\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../TaxiFarePredictionML.Model/MLModel.zip";
